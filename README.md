...
Para contornar esse problema recorremos a representação de Heisenberg, que retira a contribuição espacial e relaciona energia de estado. O problema que incialmente era uma matriz $R^{2}$ se torna 2x2, afinal, são dois estados de energia.
...
## 5. Complicações matemáticas

Mas de que forma o Hamiltoniano utilizado se torna uma matriz já que anteriormente ele era tratado como a soma de todas as energias do sistema, cinética e potencial?
